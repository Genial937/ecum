    ...
    <section class="about">
        ...
        <div class="container about-content">
            <div class="head-section text-center">
                <h2>TESTIMONIALS</h2>
                <h3><a href="<?php echo e(route('index')); ?>">Home</a> / Testimonials</h3>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\peter\resources\views/testimonials.blade.php ENDPATH**/ ?>